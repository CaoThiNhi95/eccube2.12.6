...
class SC_MyFpdf extends SC_Helper_FPDI {
    ...
    function setOrderData() {
        ...
        if ($this->arrDisp['coupon_discount_price']) {
            $i++;
            $arrOrder[$i][0] = "";
            $arrOrder[$i][1] = "";
            $arrOrder[$i][2] = "クーポン";
            $arrOrder[$i][3] = "- ".number_format($this->arrDisp['coupon_discount_price']).$monetary_unit;
		}
