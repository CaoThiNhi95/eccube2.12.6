 ...
 * @version $Id: $
 */
class SoldOutMail extends SC_Plugin_Base {
	...
	function loadClassFileChange(&$classname,&$classpath){
		if($classname == 'SC_Product_Ex'){
			$classpath = PLUGIN_UPLOAD_REALDIR . "SoldOutMail/plg_SoldOutMail_SC_Product.php";
			
			$classname = "plg_SoldOutMail_SC_Product";
		}	
	}	
