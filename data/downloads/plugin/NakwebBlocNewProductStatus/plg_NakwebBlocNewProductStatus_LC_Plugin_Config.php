 ...
 * @version $Id: $
 */
class plg_NakwebBlocNewProductStatus_LC_Plugin_Config extends LC_Page_Admin_Ex {
    ...
    function init() {
        ...
        // サブタイトル
        $this->tpl_subtitle = "商品ステータス別新着情報";
        // 管理画面で表示する説明文
        $this->tpl_note     = "商品ステータス別の新着情報を表示する際の設定が行えます。";
    }
    ...
    function lfInitParam(&$objFormParam) {
        $objFormParam->addParam('タイトル', 'title', '', '', array());
        $objFormParam->addParam('表示件数', 'limit', '', '', array('EXIST_CHECK','NUM_CHECK'));
        $objFormParam->addParam('対象日数', 'period', '', '', array('EXIST_CHECK','NUM_CHECK'));
    }
