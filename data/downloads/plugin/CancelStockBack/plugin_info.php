...
class plugin_info{
    ...
    static $PLUGIN_CODE       = "CancelStockBack";
    /** プラグイン名(必須)：EC-CUBE上で表示されるプラグイン名. */
    static $PLUGIN_NAME       = "キャンセル自動在庫戻し";
    /** クラス名(必須)：プラグインのクラス（拡張子は含まない） */
    static $CLASS_NAME        = "CancelStockBack";
    ...
    /** 説明(必須)：プラグインの説明. */
    static $DESCRIPTION       = "受注キャンセル時に在庫、利用ポイントを自動で戻します";
    /** プラグインURL：プラグイン毎に設定出来るURL（説明ページなど） */
    static $PLUGIN_SITE_URL   = "http://www.bratech.co.jp";
	static $AUTHOR_SITE_URL   = "http://www.bratech.co.jp";
	/** フックポイント **/
    static $HOOK_POINTS       = array(
		array('LC_Page_Admin_Order_Edit_action_before', 'admin_order_edit_before')
									);
    /** ライセンス */
    static $LICENSE        = "LGPL";
}
