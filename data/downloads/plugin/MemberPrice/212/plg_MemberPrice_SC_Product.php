    ...
    function setProductsClassByProductIds($arrProductId, $has_deleted = false)
    {
        ...
        foreach ($arrProductId as $productId) {
            ...
            foreach ($arrProductClasses as $arrProductsClass) {
                ...
                $arrClassCats2['plg_memberprice_price03'] = strlen($arrProductsClass['plg_memberprice_price03']) ? number_format(SC_Helper_DB_Ex::sfCalcIncTax($arrProductsClass['plg_memberprice_price03'])) : '';
...
__EOS__;
    ...
    function setPriceTaxTo($arrProducts)
    {
        foreach ($arrProducts as $key => $value) {
            ...
            $arrProducts[$key]['plg_memberprice_price03_min_format'] = number_format($arrProducts[$key]['plg_memberprice_price03_min']);
            $arrProducts[$key]['plg_memberprice_price03_max_format'] = number_format($arrProducts[$key]['plg_memberprice_price03_max']);
            ...
            $arrProducts[$key]['plg_memberprice_price03_min_tax'] = SC_Helper_DB::sfCalcIncTax($arrProducts[$key]['plg_memberprice_price03_min']);
            $arrProducts[$key]['plg_memberprice_price03_max_tax'] = SC_Helper_DB::sfCalcIncTax($arrProducts[$key]['plg_memberprice_price03_max']);
            ...
            $arrProducts[$key]['plg_memberprice_price03_min_tax_format'] = number_format($arrProducts[$key]['plg_memberprice_price03_min_tax']);
            $arrProducts[$key]['plg_memberprice_price03_max_tax_format'] = number_format($arrProducts[$key]['plg_memberprice_price03_max_tax']);
        }
        return $arrProducts;
    }
    ...
    static function setIncTaxToProduct(&$arrProduct)
    {
        ...
        $arrProduct['plg_memberprice_price03_min_inctax'] = isset($arrProduct['plg_memberprice_price03_min']) ? SC_Helper_DB::sfCalcIncTax($arrProduct['plg_memberprice_price03_min']) : null;
        $arrProduct['plg_memberprice_price03_max_inctax'] = isset($arrProduct['plg_memberprice_price03_max']) ? SC_Helper_DB::sfCalcIncTax($arrProduct['plg_memberprice_price03_max']) : null;
    }
