...
if (!$sele2.length) {
    changeMemberPrice($form, product_id, $sele1.val() ? $sele1.val() : '__unselected','0');
}else{
    changeMemberPrice($form, product_id, $sele1.val() ? $sele1.val() : '__unselected',$sele2.val() ? $sele2.val() : '__unselected');
}
//]]></script>