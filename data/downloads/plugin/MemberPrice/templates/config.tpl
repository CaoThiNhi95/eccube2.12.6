...
<table border="0" cellspacing="1" cellpadding="8" summary=" ">
    ...
    <tr >
        ...
        <td><span class="attention"><!--{$arrErr.memberprice_title}--></span><input type="text" class="box160" name="memberprice_title" value="<!--{$arrForm.memberprice_title}-->" style="<!--{if $arrErr.memberprice_title != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->"></td>
    </tr>
    <tr >
